    ...
    return (
        ...
        <div>
            { data.Search.map( (m, i) => 
                ...
                <div key={i}>
                    <Link href={'receita_5/exercicio3/movies'}><a id={m.imdbID} onClick={loadingMovie}>{m.Title}</a></Link>
                </div>  
            ) }            
...
export function TheLink({url, handler, link}){    
    ...
    return (
        ...
        <div>
            ...
            <a href="receita_5/exercicio1/movies.js" id={link} onClick={handler}> {url === '' ? 'Mostrar' : 'Ocultar'} </a>
